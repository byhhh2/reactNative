           ...
           <Stack.Navigator>
            <Stack.Screen //1
              ...
              headerRight:() => (<View style={styles.headerBtn}>
                <TouchableOpacity onPress={()=>this.toggleSettingModal()}><AntDesign name={'plus'} size={30} color={'#3F3F3F'} /></TouchableOpacity>
